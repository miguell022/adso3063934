        ...
        @empty
            ...
            <div class="flex flex-col items-center justify-center gap-6 my-20 max-w-md mx-auto">
                <div class="bg-white rounded-full p-8 shadow-2xl border-4 border-pink-200">
                    <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="#ec4899" viewBox="0 0 256 256">
                        <path d="M178,40c-20.65,0-38.73,8.88-50,23.89C116.73,48.88,98.65,40,78,40a62.07,62.07,0,0,0-62,62c0,70,103.79,126.66,108.21,129a8,8,0,0,0,7.58,0C136.21,228.66,240,172,240,102A62.07,62.07,0,0,0,178,40ZM128,214.8C109.74,204.16,32,155.69,32,102A46.06,46.06,0,0,1,78,56c19.45,0,35.78,10.36,42.6,27a8,8,0,0,0,14.8,0c6.82-16.67,23.15-27,42.6-27a46.06,46.06,0,0,1,46,46C224,155.61,146.24,204.15,128,214.8Z"></path>
                    </svg>
                </div>
                <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl border-2 border-blue-200 px-10 py-8 text-center">
                    <h3 class="text-3xl font-bold text-gray-800 mb-3">No Adoptions Yet!</h3>
                    <p class="text-gray-600 text-lg mb-6">You haven't adopted any pets yet. Start your journey and give a pet a loving home!</p>
                    <a href="{{ url('makeadoption') }}" class="btn btn-primary btn-lg gap-2 shadow-lg hover:shadow-xl transition-all">
